        ...
        <Grid item container md={12} width="100%">
          ...
          <Grid item md={4} padding="12px" sx={{ pt: 10 }}>
            <Grid sx={{ pt: 2 }}>
              ...
              <Typography text={petCategory} customStyle={{ fontSize: '12px', color: '#2C3051' }} />
            </Grid>
            <Grid>
              <Typography text="Address" customStyle={{ fontSize: '17px', color: '#9597A8' }} />
              <Typography text={address} customStyle={{ fontSize: '12px', color: '#2C3051' }} />
            </Grid>
          </Grid>
          <Grid item md={5.5}>
